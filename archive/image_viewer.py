...
img = mpimg.imread('Basil_Trial/21-06-22/Qtcam_22_06_21:20_20_05-1.jpg')
print(img)
...
imgplot = plt.imshow(lum_img, clim=(190, 250))
plt.show()
...
img = Image.open('Basil_Trial/21-06-22/Qtcam_22_06_21:20_20_05-1.jpg')
img.thumbnail((64, 64), Resampling.LANCZOS)  # resizes image in-place
imgplot = plt.imshow(img)
plt.show()
